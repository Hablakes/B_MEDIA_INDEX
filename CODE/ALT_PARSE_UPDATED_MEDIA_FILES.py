...
def movie_index_results(username_input='bx'):
...
def tv_show_index_results(username_input='bx'):
...
def create_media_files_index_results_csv(username_input='bx'):
...
create_media_files_index_results_csv(username_input='bx')
