...
def search_movie_folders_items_re():
...
def create_media_index_csv():
    search_movie_folders_items_re()
    with open(r"/home/bx/PycharmProjects/B-MEDIA-INDEX/FILES/MOVIE-FILES-RESULTS-RE.csv", "w", newline="") as f:
