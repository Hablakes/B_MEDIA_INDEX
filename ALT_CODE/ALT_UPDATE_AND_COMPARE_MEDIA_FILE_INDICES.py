...
def compare_old_and_updated_indices_and_create_differences_files(username_input, movie_dir_input, movie_alt_dir_input,
                                                                 tv_dir_input, tv_alt_dir_input):
    rename_existing_movie_and_tv_indices_for_update_search(username_input)
    create_media_files_indices(username_input, movie_dir_input, movie_alt_dir_input, tv_dir_input, tv_alt_dir_input)
